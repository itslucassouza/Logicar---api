...
export class CarService {
    ...
    async updateCar(plate: string) {
      ...
      const checkIfTransactionAlreadyExist = transactions[0].filter((item) => item.exitTime === null)
      ...
      return this.transactionService.updateTransaction(checkIfTransactionAlreadyExist[0].id)
